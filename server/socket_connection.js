...
class SocketConnect {
    ...
    emitSessionList(session_id = null){
        if (session_id) {
            ...
            console.log("clients %o", this.clients)
            
            session.players.forEach((player) => {
                console.log(`updating session for ${player.socket_id}`)
                
                this.clients[player.socket_id]
    ...
    emitOnWinner(session_id) {
        ...
        session.players.forEach((player) => {
            this.io.sockets[player.socket_id]
